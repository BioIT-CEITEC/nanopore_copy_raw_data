...
rule all:
    input:
        expand("{library_name}/raw_reads/{sample_name}/{sample_name}.pod5", library_name=library_name, sample_name=sample_names),
        expand("{library_name}/run_report/{sample_name}/{sample_name}_report.json", library_name=library_name, sample_name=sample_names)
